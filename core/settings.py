...
ALLOWED_HOSTS = ['snouk-images.azurewebsites.net']
...
AZURE_ACCOUNT_NAME = os.getenv('snouk')
AZURE_ACCOUNT_KEY = os.getenv('n78aMek/MNkyxJ7fa5FsmlYl4OCZYQ5aL35aOuVSgqRyxqsrF/SonWh6k1cHboj/3lmr0U5Kw7EP+AStYNQINQ==')
